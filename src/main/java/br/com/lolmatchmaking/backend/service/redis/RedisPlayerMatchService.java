...
public class RedisPlayerMatchService {
    ...
    // ✅ REMOVIDO: PUUID_TO_PLAYER_PREFIX - chave duplicada desnecessária
    // Usar apenas ws:client_info:{summonerName} que já contém todas as informações
    ...
    // ✅ REMOVIDO: Métodos de constraint PUUID - chaves duplicadas desnecessárias
    // Usar apenas ws:client_info:{summonerName} que já contém todas as informações
    ...
    public boolean validateOwnership(String summonerName, Long matchId, String puuid) {
        try {
            ...
            if (puuid != null && !puuid.isEmpty()) {
                log.debug("✅ [RedisPlayerMatch] PUUID validado via ClientInfo: {} → {}",
